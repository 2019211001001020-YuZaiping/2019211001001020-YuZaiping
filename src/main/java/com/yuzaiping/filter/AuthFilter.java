...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        System.out.println("i am AuthFilter-->doFilter()- before servlet -(request come here)");//when called?
        ...
        System.out.println("i am AuthFilter -->doFilter()- after servlet -(response come here)");//when called?
    }
}
