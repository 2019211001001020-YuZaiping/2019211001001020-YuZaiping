...
<% if(!(request.getAttribute("user")==null)){
   ...
   com.yuzaiping.model.User u = (com.yuzaiping.model.User)request.getAttribute("user");
%>
...
<form method="post" action="updateUser">
   <label>Username : </label> <input type="text" name="username" placeholder="Username" value="<%=u.getUsername()%>"/>
    ...
    <label>Email : </label><input type="text" name="email" placeholder="Email" value="<%=u.getEmail()%>"/><br/>
 	...
 	<br/><br/>
   <label>Date of Birth : </label><input type="text" name="birthday" placeholder="Date of Birth (yyyy-mm-dd)" value="<%=u.getBirthday()%>" />
