			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.yuzaiping.model.Order o=(com.yuzaiping.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.yuzaiping.dao.UserDao userDao=new com.yuzaiping.dao.UserDao();
						...
						<%
							...
							String paymentType=com.yuzaiping.model.Payment.findByPaymentId(con,n);
							 %>
